...
The artifact is a standalone Portable Operating System Interface (POSIX)
...
Copyright {url-cv}[David Rabkin].
Released under the {url-license}[Zero-Clause BSD license].
